...
<p align="center">
  <table>
    <tr>
      <td align="center"><sub><b>Android</b></sub><br /><img src="docs/screenshots/android-home.png" alt="Android home" width="220" /></td>
      <td align="center"><sub><b>iOS</b></sub><br /><img src="docs/screenshots/ios-home.png" alt="iOS home" width="220" /></td>
      <td align="center"><sub><b>macOS</b></sub><br /><img src="docs/screenshots/macos-home.png" alt="macOS home" width="360" /></td>
    </tr>
  </table>
</p>

> Screenshots are generated by scripts so they always match the real UI (see "Screenshot automation" below). To produce the Windows shot, run `./tool/screenshot_desktop.sh windows` on a Windows machine.
...
The product screenshots in this README are generated by scripts so they always match the real UI:

```bash
# Mobile: launch the app, then capture with OS tooling
...
# Desktop: launch the app, then OS-level window/screen capture
./tool/screenshot_desktop.sh macos      # macOS: screencapture window region
./tool/screenshot_desktop.sh windows    # Windows: PowerShell full-screen capture
```

> Note: neither `integration_test`'s `takeScreenshot()` nor `flutter screenshot` supports desktop, so desktop uses OS-level capture; [`integration_test/screenshot_test.dart`](integration_test/screenshot_test.dart) remains available for supported platforms.
